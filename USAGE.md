...
>
> **Documentation style:** `writer-agent` dùng **một template duy nhất** — [templates/report-style.md](./templates/report-style.md) (embedded CSS, diagram panels, section headers, item cards, Mermaid patterns). Repo đích có convention mạnh hơn (`docs/REPORT-STYLE.md`) thì ưu tiên local.
...
Style: follow cursor-agents `templates/report-style.md` unless the target repo has stronger local doc conventions.
```
...
| [templates/report-style.md](./templates/report-style.md) | Report template duy nhất cho writer-agent (CSS, diagram panels, Mermaid, item cards) |
| [templates/documentation-style.md](./templates/documentation-style.md) | Deprecated — redirect tới report-style.md |
