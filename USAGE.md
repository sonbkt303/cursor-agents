...
> **Ghi nhớ:** Bộ agents có 8 pipeline và vòng ADV/review — đó là **công cụ cho task lớn**, không phải checklist bắt buộc mỗi lần sửa code.
...
```text
Dùng orchestrator, pipeline [FullFeature|RequirementsOnly|ArchitectureOnly|RefactorOnly|BugFixOnly|IncidentToRunbook|CodeReviewOnly|DocsOnly].
Brief: <mô tả ngắn>
